...
const ClassItem = ({ classLevel }) => {
  return (
    <>
      <div className="class-item py-5 text-black flex flex-col items-center justify-center grow bg-white rounded-lg border-2 border-transparent duration-150 hover:border-green-400 hover:-mt-4 hover:mb-4">
        <img
          className="mb-4"
          width="48"
          height="48"
